		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-12 col-lg-8">
					<img src="/images/{{$story->image}}" alt="">
					...
					<ul class="list-li-mr-20 mtb-15">
						...
						<li><i class="color-primary mr-5 font-12 ion-ios-bolt"></i>{{$story->view_count}}</li>
					...
					<h4 class="p-title mt-20"><b>{{count($story->comments)}} COMMENTS</b></h4>
					
					@include('partials._comment_replies', ['comments' => $story->comments, 'story_id' => $story->id])
					

					<h4 class="p-title mt-20"><b>LEAVE A COMMENT</b></h4>
					
					<form method="POST" action="{{route('comment.add')}}" class="form-block form-plr-15 form-h-45 form-mb-20 form-brdr-lite-white mb-md-50">
						@csrf
						<input type="text" placeholder="Post title*:" required>
						<textarea class="ptb-10" name="comment_body" placeholder="Your Comment" required></textarea>
