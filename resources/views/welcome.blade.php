...
<body>
    ...
    <header>
                ...
                <div class="oflow-hidden color-ash font-9 text-sm-center ptb-sm-5">
                 @if(Route::has('login'))
                    <ul class="float-left float-sm-none list-a-plr-10 list-a-plr-sm-5 list-a-ptb-15 list-a-ptb-sm-10">
                        ...
                        @auth()
                         <li><a href="{{url('/series/create')}}">New Serie</a></li>
                         <li><a href="{{url('/stories/create')}}">New Story</a></li>
                         <li><a href="{{ url('/myseries') }}">My Series</a></li>
        ...
        <div class="container">
            <a class="logo" href="index.html"><img src="images/My-Story-Logo-RGB.png" alt="Logo"></a>
            ...
            <div class="src-form">
                ...
                <form action="/search" method="POST">
                    {{csrf_field()}}
                    <input type="text" placeholder="Search here" class="typeahead form-control" name="search">
        ...
        <div class="h-600x h-sm-auto">
            <div class="h-2-3 h-sm-auto oflow-hidden">
                ...
                <div class="pb-5 pr-5 pr-sm-0 float-left float-sm-none w-2-3 w-sm-100 h-100 h-sm-300x">
                    <a class="pos-relative h-100 dplay-block" href="/stories/{{$stories[count($stories)-1]->id}}">
                    
                        <div><img src="/images/{{$stories[count($stories)-1]->image}}"></div>
                        
                        <div class="abs-blr color-white p-20 bg-sm-color-7">
                            <h3 class="mb-15 mb-sm-5 font-sm-13"><b>{{$stories[count($stories)-1]->title}}</b></h3>
                            <ul class="list-li-mr-20">
                                <li>by <span class="color-primary"><b>{{$users[($stories[count($stories)-1]->owner_id)-1]->name}}</b></span> {{$stories[count($stories)-1]->created_at}}</li>
                                <li><i class="color-primary mr-5 font-12 ion-ios-bolt"></i>{{$stories[count($stories)-1]->view_count}}</li>
                                <li><i class="color-primary mr-5 font-12 ion-chatbubbles"></i>{{count($stories[count($stories)-1]->comments)}}</li>
                            </ul>
                        </div><!--abs-blr -->
                    </a><!-- pos-relative -->
                </div><!-- w-1-3 -->
                ...
                <div class="float-left float-sm-none w-1-3 w-sm-100 h-100 h-sm-600x">
                    ...
                    <div class="pl-5 pb-5 pl-sm-0 ptb-sm-5 pos-relative h-50">
                        <a class="pos-relative h-100 dplay-block" href="/stories/{{$stories[count($stories)-2]->id}}">
                        
                            <div><img src="/images/{{$stories[count($stories)-2]->image}}"></div>
                    ...
                    <div class="pl-5 ptb-5 pl-sm-0 pos-relative h-50">
                        <a class="pos-relative h-100 dplay-block" href="/stories/{{$stories[count($stories)-3]->id}}">
                        
                            <div><img src="/images/{{$stories[count($stories)-3]->image}}"></div>
            ...
            <div class="h-1-3 oflow-hidden">
                ...
                <div class="pr-5 pr-sm-0 pt-5 float-left float-sm-none pos-relative w-1-3 w-sm-100 h-100 h-sm-300x">
                    <a class="pos-relative h-100 dplay-block" href="/stories/{{$stories[count($stories)-4]->id}}">
                    
                        <div><img src="/images/{{$stories[count($stories)-4]->image}}"></div>
                ...
                <div class="plr-5 plr-sm-0 pt-5 pt-sm-10 float-left float-sm-none pos-relative w-1-3 w-sm-100 h-100 h-sm-300x">
                    <a class="pos-relative h-100 dplay-block" href="/stories/{{$stories[count($stories)-5]->id}}">
                    
                        <div><img src="/images/{{$stories[count($stories)-5]->image}}"></div>
                ...
                <div class="pl-5 pl-sm-0 pt-5 pt-sm-10 float-left float-sm-none pos-relative w-1-3 w-sm-100 h-100 h-sm-300x">
                    <a class="pos-relative h-100 dplay-block" href="/stories/{{$stories[count($stories)-6]->id}}">
                    
                        <div><img src="/images/{{$stories[count($stories)-6]->image}}"></div>
